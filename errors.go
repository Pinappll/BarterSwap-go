...
var (
	...
	ErrUnauthorized = errors.New("authentification requise (header X-User-ID manquant ou invalide)")
	ErrForbidden    = errors.New("vous n'êtes pas autorisé à effectuer cette action")
